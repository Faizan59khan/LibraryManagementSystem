...
public class Home extends JFrame implements ActionListener{
	...
	private JPanel contentPane;
        private JButton b1,b2,b3,b4,b5,b6,b8;
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            //add
             JMenuItem totalbooks = new JMenuItem("Total Strength");
            totalbooks.setBackground(new Color(211, 211, 211));
            totalbooks.setForeground(Color.DARK_GRAY);
            totalbooks.addActionListener(this);
            mnRecord.add(totalbooks);
		...
		new BookDetails().setVisible(true);
            ...
            //add
            else if(msg.equals("Total Strength")){
                setVisible(false);
                new TotalStrength().setVisible(true);
