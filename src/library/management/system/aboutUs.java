	...
	private JPanel contentPane;
        ...
        public aboutUs() {
           ...
           /* JLabel l1 = new JLabel("New label");
            ...
            l3.setBounds(240, 40, 150, 55);
            contentPane.add(l3);

            JLabel l4 = new JLabel("Mangement System");
            l4.setForeground(new Color(127, 255, 0));
            l4.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 34));
            l4.setBounds(150, 90, 405, 40);
            contentPane.add(l4);
            ...
            l6.setBounds(175, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Muhammad Faizan");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(160, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Maham Anwar");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(160, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Lihaz Ali Shah");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(160, 320, 600, 34);
            contentPane.add(l9);
